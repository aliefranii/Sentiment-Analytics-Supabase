<div class="w-full h-[450px] bg-white rounded-lg shadow-md py-4 md:py-6">
    ...
    <div class="overflow-x-auto px-4">
        <div class="flex items-center justify-center min-w-[600px] h-[300px]">
            <canvas id="cihuy" class="w-full h-full"></canvas>
            <p id="sourceNoDataMessagebar" class="hidden text-gray-500 text-center mt-4">
