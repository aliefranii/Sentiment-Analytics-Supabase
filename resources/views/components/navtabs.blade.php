<div class="w-full flex justify-center items-center bg-gray-200 py-2 rounded-lg shadow-md">
    <ul class="flex flex-wrap justify-center items-center space-x-2">
        <li class="{{ request()->is('overview') ? 'bg-white' : 'bg-transparent' }} p-3 rounded-md flex-shrink-0">
            <a href="{{ url('/overview') }}"
        ...
        <li class="{{ request()->is('sources') ? 'bg-white' : 'bg-transparent' }} p-3 rounded-md flex-shrink-0">
            <a href="{{ url('/sources') }}"
        ...
        <li class="{{ request()->is('trends') ? 'bg-white' : 'bg-transparent' }} p-3 rounded-md flex-shrink-0">
            <a href="{{ url('/trends') }}"
        ...
        <li class="{{ request()->is('mentions') ? 'bg-white' : 'bg-transparent' }} p-3 rounded-md flex-shrink-0">
            <a href="{{ url('/mentions') }}"
